...
class UpdatesScreenState extends State<UpdatesScreen> {
  ...
  PreferredSizeWidget _buildAppBar(
      BuildContext context, ItemList model, String? title) {
    return CustomAppBar(
        height: 52.v,
        leadingWidth: 51.h,
        ...
        title:
            AppbarTitle(text: title ?? "", margin: EdgeInsets.only(left: 14.h)),
        actions: [
          // AppbarSubtitleOne(
          //     text: "lbl_share".tr,

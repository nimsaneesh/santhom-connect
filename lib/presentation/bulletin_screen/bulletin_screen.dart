...
import 'provider/bulletin_provider.dart';
...
class BulletinScreenState extends State<BulletinScreen> {
  ...
  Widget build(BuildContext context) {
    DetailModelBulletin? items =
        ModalRoute.of(context)!.settings.arguments as DetailModelBulletin;
    Lists model = items.model!;
    return Scaffold(
        resizeToAvoidBottomInset: true,
        appBar: _buildAppBar(context, model, items.title),
        body: Container(
            ...
            child:
              ...
              Padding(
                  ...
                  child: Selector<BulletinProvider, TextEditingController?>(
  ...
  PreferredSizeWidget _buildAppBar(
      BuildContext context, Lists model, String title) {
    return CustomAppBar(
        height: 52.v,
        leadingWidth: 51.h,
        ...
        title: AppbarTitle(text: title, margin: EdgeInsets.only(left: 14.h)),
        actions: [
          Text(
            "Share".tr,
            style: TextStyle(
